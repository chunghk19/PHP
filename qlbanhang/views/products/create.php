...
<head>
  ...
  <title>Thêm Sản Phẩm Mới - TV Store</title>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Thêm Sản Phẩm Mới</a>
          </div>
        </div>
      </nav>
      <!-- End Navbar -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <p class="card-category">Điền thông tin sản phẩm</p>
              </div>
              <div class="card-body">
                <form method="POST" action="/qlbanhang/admin.php?page=products&action=create" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-6">
