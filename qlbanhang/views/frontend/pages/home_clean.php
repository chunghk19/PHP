			...
			<div id="top-header">
				<div class="container">
					...
					<ul class="header-links pull-right">
						...
						<li><a href="/qlbanhang/frontend.php?page=login"><i class="fa fa-user-o"></i> Đăng nhập</a></li>
					</ul>
				</div>
			</div>
			<!-- /TOP HEADER -->
									...
									<div class="products-slick" data-nav="#slick-nav-1">
										<?php if (isset($featuredProducts) && !empty($featuredProducts)): ?>
											<?php foreach ($featuredProducts as $product): ?>
												...
												<div class="product">
													<div class="product-img">
														<img src="/qlbanhang/public/uploads/products/<?= $product['image'] ?>" alt="">
													</div>
													<div class="product-body">
														...
														<h4 class="product-price"><?= number_format($product['price']) ?>đ 
															<?php if ($product['sale_price'] < $product['price']): ?>
																<del class="product-old-price"><?= number_format($product['price']) ?>đ</del>
															<?php endif; ?>
														</h4>
